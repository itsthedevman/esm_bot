...
class Faye::WebSocket::SslVerifier
  ...
  # source://faye-websocket//lib/faye/websocket/ssl_verifier.rb#57
  def ssl_handshake_completed; end
  ...
  # @return [Boolean]
  #
  # source://faye-websocket//lib/faye/websocket/ssl_verifier.rb#83
  def identity_verified?; end

  # source://faye-websocket//lib/faye/websocket/ssl_verifier.rb#71
  def parse_cert(cert_text); end

  # @return [Boolean]
  #
  # source://faye-websocket//lib/faye/websocket/ssl_verifier.rb#67
  def should_verify?; end

  # source://faye-websocket//lib/faye/websocket/ssl_verifier.rb#77
