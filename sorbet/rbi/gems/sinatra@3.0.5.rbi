...
class Rack::Builder
  ...
  # source://rack/2.2.6.2/lib/rack/builder.rb#123
  def initialize(default_app = T.unsafe(nil), &block); end

  # source://rack/2.2.6.2/lib/rack/builder.rb#243
  def call(env); end

  # source://rack/2.2.6.2/lib/rack/builder.rb#226
  def freeze_app; end

  # source://rack/2.2.6.2/lib/rack/builder.rb#219
  def map(path, &block); end

  # source://rack/2.2.6.2/lib/rack/builder.rb#176
  def run(app); end

  # source://rack/2.2.6.2/lib/rack/builder.rb#231
  def to_app; end

  # source://rack/2.2.6.2/lib/rack/builder.rb#153
  def use(middleware, *args, &block); end

  # source://rack/2.2.6.2/lib/rack/builder.rb#190
  def warmup(prc = T.unsafe(nil), &block); end

  private

  # source://rack/2.2.6.2/lib/rack/builder.rb#251
  def generate_map(default_app, mapping); end

  class << self
    # source://rack/2.2.6.2/lib/rack/builder.rb#130
    def app(default_app = T.unsafe(nil), &block); end

    # source://rack/2.2.6.2/lib/rack/builder.rb#93
    def load_file(path, opts = T.unsafe(nil)); end

    # source://rack/2.2.6.2/lib/rack/builder.rb#112
    def new_from_string(builder_script, file = T.unsafe(nil)); end

    # source://rack/2.2.6.2/lib/rack/builder.rb#64
    def parse_file(config, opts = T.unsafe(nil)); end
  end
end

class Rack::CommonLogger
  # source://rack/2.2.6.2/lib/rack/common_logger.rb#24
  def initialize(app, logger = T.unsafe(nil)); end

  # source://sinatra//lib/sinatra/base.rb#259
  def call(env); end

  # source://rack/2.2.6.2/lib/rack/common_logger.rb#36
  def call_without_check(env); end

  private

  # source://rack/2.2.6.2/lib/rack/common_logger.rb#78
  def extract_content_length(headers); end

  # source://rack/2.2.6.2/lib/rack/common_logger.rb#47
...
#
# source://sinatra//lib/sinatra/base.rb#1950
...
#
# source://sinatra//lib/sinatra/base.rb#908
class Sinatra::Base
  include ::Rack::Utils
...
# at the top-level.
#
# source://sinatra//lib/sinatra/base.rb#1966
...
class Sinatra::Request < ::Rack::Request
  ...
  # source://rack/2.2.6.2/lib/rack/request.rb#350
  def secure?; end
...
#
# source://sinatra//lib/sinatra/base.rb#726
...
# source://sinatra//lib/sinatra/base.rb#1992
