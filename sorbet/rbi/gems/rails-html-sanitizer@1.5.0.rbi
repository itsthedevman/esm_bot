...
module ActionView::Helpers::SanitizeHelper
  ...
  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#81
  def sanitize(html, options = T.unsafe(nil)); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#86
  def sanitize_css(style); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#120
  def strip_links(html); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#103
  def strip_tags(html); end
end

# source://rails-html-sanitizer//lib/rails-html-sanitizer.rb#33
module ActionView::Helpers::SanitizeHelper::ClassMethods
  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#145
  def full_sanitizer; end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#125
  def full_sanitizer=(_arg0); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#155
  def link_sanitizer; end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#125
  def link_sanitizer=(_arg0); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#165
  def safe_list_sanitizer; end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#125
  def safe_list_sanitizer=(_arg0); end

  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#135
  ...
  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#131
  ...
  # source://actionview/6.1.7.2/lib/action_view/helpers/sanitize_helper.rb#127
...
module Rails
  class << self
    # source://railties/6.1.7.2/lib/rails.rb#38
    def app_class; end

    # source://railties/6.1.7.2/lib/rails.rb#38
    def app_class=(_arg0); end

    # source://railties/6.1.7.2/lib/rails.rb#39
    def application; end

    # source://railties/6.1.7.2/lib/rails.rb#37
    def application=(_arg0); end

    # source://railties/6.1.7.2/lib/rails.rb#112
    def autoloaders; end

    # source://railties/6.1.7.2/lib/rails.rb#50
    ...
    # source://railties/6.1.7.2/lib/rails.rb#46
    def configuration; end

    # source://railties/6.1.7.2/lib/rails.rb#72
    def env; end

    # source://railties/6.1.7.2/lib/rails.rb#79
    def env=(environment); end

    # source://railties/6.1.7.2/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/6.1.7.2/lib/rails.rb#92
    def groups(*groups); end

    # source://railties/6.1.7.2/lib/rails.rb#43
    ...
    # source://railties/6.1.7.2/lib/rails.rb#108
    def public_path; end

    # source://railties/6.1.7.2/lib/rails.rb#63
    def root; end

    # source://railties/6.1.7.2/lib/rails/version.rb#7
    def version; end
  end
end
