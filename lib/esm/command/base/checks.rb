    ...
    class Base
      class Checks
        ...
        def run_all!
          ...
          different_community!
          cooldown!
          connected_server! unless skipped_check?(:connected_server)
        end
        ...
        def cooldown!
          ...
          return if skipped_check?(:cooldown)
        ...
        def nil_target_user!
          return if skipped_check?(:nil_target_user)
